...
const ENDPOINT = 'https://backend-consult-sched-production.up.railway.app';
...
const Chat = ({ fetchAgain, setFetchAgain }) => {
    ...
    const fetchMessages = async () => {
        ...
        try {
            setLoading(true)
            const response = await fetch(`https://backend-consult-sched-production.up.railway.app/api/chat/${selectedChat._id}`, {
                headers: {
